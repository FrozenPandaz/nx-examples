...
import { Button9Component } from './button9/button9.component';
            ...
            @NgModule({
              ...
              declarations: [Button0Component, Button1Component, Button2Component, Button3Component, Button4Component, Button5Component, Button6Component, Button7Component, Button8Component, Button9Component]
            })
            export class Lib434Module { }
